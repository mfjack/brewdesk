  ...
  return (
    <section className="flex flex-col h-screen">
      <div className="flex flex-col p-4">
        <Header title="Produtos" description="Gerencie os produtos: adicione e remova produtos." />
      </div>

      <Separator className="h-px w-full" />

      <form className="flex items-center flex-row gap-2 w-full p-4" onSubmit={handleSubmit(handleCreateProduct)}>
