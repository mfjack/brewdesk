...
export function BackupSection() {
  ...
  async function handleExportData() {
    ...
    anchor.href = url;
    anchor.download = `tably-backup-${new Date().toISOString().slice(0, 10)}.json`;
    anchor.click();
  ...
  function handleImportFileChange(event: ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = () => {
      try {
        ...
        setImportError("Arquivo inválido. Selecione um backup exportado pelo Tably.");
      } finally {
    ...
    <div className="max-w-lg space-y-3">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Os dados ficam salvos na nuvem. Exporte um backup regularmente como cópia de segurança extra.
        </p>
      </div>
